...
const Players = ({ playersPromise, setCoin, coin }) => {
    ...
    return (
        <div className='container mx-auto'>
            <div className='flex justify-between items-center my-2'>
                {selectedType === "available" ?
                    ...
                    : (<h2 className='font-bold text-xl'>
                        Selected Players ({selectedPlayers.length}/{players.length})</h2>)}
                <div>
                    <button
            ...
            {selectedType === "available" ? (<Avaliable players={players} setCoin={setCoin} coin={coin} setSelectedPlayers={setSelectedPlayers} selectedPlayers={selectedPlayers}></Avaliable>) :
